...
import xyz.cesarh.persona.persona.model.Pais;
import xyz.cesarh.persona.persona.repository.PaisRepository;

@Service
public class PaisService implements JpaRepository<Pais, Long>{
